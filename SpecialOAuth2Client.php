...
class SpecialOAuth2Client extends SpecialPage {
	...
	public function __construct(){
		...
		$this->_clientId = $wgConsumerKey;
		$this->_clientSecret = $wgConsumerSecret;
	}
	...
	private function _redirect(){
		...
		$connection = new MwTwitterOAuth( $this->_clientId, $this->_clientSecret );
	...
	private function _isCreatedFromTwitter( $user ){
		...
		$res = $dbr->select( $this->_euTable, 'tl_twitter_id',		//'tl_relation'
